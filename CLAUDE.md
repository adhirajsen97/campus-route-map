...
MavPath is a Google Maps-powered campus navigation web application built with React 18, TypeScript, and Tailwind CSS. The app provides interactive campus mapping, building search, route planning, and location-based features. It uses a hybrid data approach: Google Maps POI data for buildings and a web scraper for campus events.
